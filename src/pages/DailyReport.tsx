...
import { downloadCSV, todayStr, formatDate, formatDateTime } from '@/utils';
import {
  BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer,
  LineChart, Line, PieChart, Pie, Cell, Legend,
} from 'recharts';

type DailyReportTab = 'overview' | 'export';
                  ...
                  {filteredExportRecords.map(r => (
                    <tr key={r.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-right tabular-nums text-slate-700">
                        <span className="font-medium text-blue-600">{r.recordCount}</span>
